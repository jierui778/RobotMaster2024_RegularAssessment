...
- DMA中断回调方式回传串口数据和数据长度
- ~~使用二值信号量实现DMA中断和串口回传任务同步~~
...
<center class = 'img'>
<img src = "./gif/imu原始数据读取.gif" width = 90%>
</center>

- MahonyAHRS解算欧拉角数据分析（仅对陀螺仪进行去零漂，静止状态下yaw角一分钟飘2度左右）

<center class = 'img'>
<img src = "./gif/Mahony数据分析.png" width = 90%>
</center>

- MahonyAHRS解算欧拉角3d演示

<center class = 'img'>
<img src = "./gif/Mahony滤波3D演示.gif" width = 90%>
</center>
...
<center class ='img'>
<img src="./gif/电机信息读取.png"  width = 90%>
</center>
...
<center class ='img'>
<img src="./gif/阶跃信号角度环超调分析.png"  width = 90%>
</center>

<details><summary>更多测试<em><b> </b> </em></summary>

- **模拟负载的阶跃式**角度变化：

<center class ='img'>
<img src="./gif/模拟负载阶跃信号角度整体跟随情况.png"  width = 90%>
</center>

- **空载的正弦式**角度变化：

<center class ='img'>
<img src="./gif/无负载正弦角度整体跟随情况.png"  width = 90%>
</center>

- **模拟负载的正弦式**角度变化：

<center class ='img'>
<img src="./gif/模拟负载正弦角度整体跟随情况.png"  width = 90%>
</center>
...
<center class ='img'>
<img src="./gif/模拟负载阶跃信号速度整体跟随情况.png"  width = 90%>
</center>

- **空载的正弦式**速度变化：

<center class ='img'>
<img src="./gif/无负载正弦速度整体跟随情况.png"  width = 90%>
</center>

- **模拟负载的正弦式**速度变化：

<center class ='img'>
<img src="./gif/模拟负载正弦速度整体跟随情况.png"  width = 90%>
</center>
...
<center class ='img'>
<img src="./gif/trace.png"  width = 90%>
</center>
